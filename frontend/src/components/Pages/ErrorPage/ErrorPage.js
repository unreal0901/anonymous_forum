...
const ErrorPage = () => {
  ...
  return (
    <>
      <div className="relative flex items-end justify-center h-screen bg-[#317FB6]">
        <NavLink
          to="/"
          className="absolute top-0 p-3 mt-2 bg-[#083352] font-bold rounded-md text-[2rem] text-white"
        >
          Go to home
        </NavLink>
